...
class StudentDatabase{
  ...
  public void insertStudentDetails(){
    ...
    try{
      ...
      Console.WriteLine("Your Register Number is: "+getRegisterNumberFromDB(student.EmailId));
  ...
  public int getRegisterNumberFromDB(string emailID){
    int registerNo=0;
    ...
    try{
      ...
      while(dataReader.Read()){
        registerNo = Convert.ToInt32(dataReader.GetValue(0).ToString());
        // Console.WriteLine();  
  ...
  public void viewStudentDetails(int regNumber){
    // regNumber = getRegisterNumber();
    ...
    try{
      ...
      SqlDataReader dataReader = displayCommand.ExecuteReader(); 
        ...
        while(dataReader.Read()){
          ...
          Console.WriteLine("Register Number: "+Convert.ToInt32(dataReader.GetValue(0))+
          ...
          "\nMobile Number: "+Convert.ToInt64(dataReader.GetValue(5))+
          ...
          // "\nCGPA: "+Convert.ToSingle(dataReader.GetValue(10))
...
public void viewStudentCGPA(int regNumber){
    // regNumber = getRegisterNumber();
    ...
    try{
      ...
      // Display student CGPA details
        while(dataReader.Read()){
          Console.WriteLine("------------------------------------------------------\n");
          Console.WriteLine("The CGPA obtained by the student is : "+Convert.ToSingle(dataReader.GetValue(0)));
          Console.WriteLine("------------------------------------------------------\n");
          Console.WriteLine();  
        }   
      con.Close();
  ...
  public void updateStudentDetails(int registerNumber){
    try{
      char ch = 'n';
  ...
  public bool authenticateUser(int registerNumber,string password){
    bool isValidUser = false;
    // int registerNumber = getRegisterNumber();
